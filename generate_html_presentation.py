            ...
            <div class="slide11-grid">
                ...
                <div class="slide11-card">
                    <div class="slide11-card-title" style="justify-content:space-between; margin-bottom:4px;">
                        <span><span>🔌</span> Live Circuit Simulation (Fig. 2)</span>
...
function updateDemoUI() {
    ...
    function renderCircuitCanvas() {
        ...
        if (leg4Fault) {
            ...
            ctx.textAlign = 'center';
            ctx.fillText('⚠️ Leg 4 Fault (Isolated)', crossX, neutralY - 9 * dpr);
        } else {
            ...
            ctx.textAlign = 'center';
            ctx.fillText('Neutral Conductor (Leg 4)', (legX[3] + motorCenterX) / 2, neutralY - 6 * dpr);
        }
