            ...
            <div class="slide11-grid">
                ...
                <div class="slide11-card">
                    <div class="slide11-card-title" style="justify-content:space-between; margin-bottom:4px;">
                        <span><span>🔌</span> מעגל Series-End VSI וסלילים טוריים (איור 2)</span>
                        <div style="display:flex; gap:4px;">
                            <button id="btn-tab-circuit" class="demo-btn active-tab" onclick="setPanel2Tab('circuit')" style="padding:2px 7px; font-size:0.72rem; background:rgba(0,210,255,0.25); border-color:#00d2ff; color:#fff;">מעגל חי</button>
                            <button id="btn-tab-matrix" class="demo-btn" onclick="setPanel2Tab('matrix')" style="padding:2px 7px; font-size:0.72rem; opacity:0.65;">מטריצה</button>
                        </div>
                    </div>
                    ...
                    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:2px;">
                        <div style="display:flex; align-items:center; gap:5px;">
                            <span style="font-size:0.75rem; color:var(--text-muted);">עדיפות:</span>
                            <div id="demo-badge-order" class="demo-order-tag" style="font-size:0.85rem; padding:0 6px;">CBA</div>
                        </div>
                        <div style="display:flex; align-items:center; gap:5px;">
                            <span style="font-size:0.75rem; color:var(--text-muted);">וקטור:</span>
                    ...
                    <div id="panel2-view-circuit" style="display:block;">
                        ...
                        <div style="font-size:0.68rem; color:var(--text-muted); text-align:center; margin-top:2px; font-weight:500;">חיבור סלילים טורי בין ענפי הממיר L1-L4 (ללא כוכב וללא משולש)</div>
                    ...
                    <div class="demo-impact-hero" style="margin-top:2px; font-size:0.75rem; padding:2px 4px;">
                        ...
                        • נורמה: <span id="demo-tel-norm" class="demo-val-readout" style="color:#00d2ff; font-weight:700;">0.10 A</span>
                    </div>
                </div>
...
function updateDemoUI() {
    ...
    function renderCircuitCanvas() {
        ...
        if (isLeg4Fault) {
            ...
            ctx.textAlign = 'center';
            ctx.fillText('⚠️ תקלת ענף L4 (מנותק)', lx4, midY + 16 * dpr);
        }
