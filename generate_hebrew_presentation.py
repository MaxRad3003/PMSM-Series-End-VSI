            ...
            <div class="slide11-grid">
                ...
                <div class="slide11-card">
                    <div class="slide11-card-title" style="justify-content:space-between; margin-bottom:4px;">
                        <span><span>🔌</span> מעגל אלקטרוני חי (איור 2)</span>
...
function updateDemoUI() {
    ...
    function renderCircuitCanvas() {
        ...
        if (leg4Fault) {
            ...
            ctx.textAlign = 'center';
            ctx.fillText('⚠️ תקלת ענף 4 (מנותק)', crossX, neutralY - 9 * dpr);
        } else {
            ...
            ctx.textAlign = 'center';
            ctx.fillText('מוליך נייטרל (ענף 4)', (legX[3] + motorCenterX) / 2, neutralY - 6 * dpr);
        }
