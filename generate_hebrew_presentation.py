"""
Generate Hebrew Presentations (HTML & PPTX) for OEPC SE-VSI PMSM Project.
Fully translated and tailored with professional Hebrew power electronics & motor drive terminology.
Includes:
- Full RTL layout and typography.
- MathJax LaTeX support.
- All 16 structured slides matching the IEEE TIE research and hardware validation.
"""
...
# ==============================================================================
# 1. HTML PRESENTATION (HEBREW RTL)
# ==============================================================================
html_he_content = r"""<!DOCTYPE html>
<html lang="he" dir="rtl">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>בקרה אופטימלית מבוססת תעדוף שגיאה (OEPC) למנועי PMSM בממיר Series-End VSI</title>
    <link href="https://fonts.googleapis.com/css2?family=Heebo:wght@300;400;500;600;700;800;900&family=Rubik:wght@400;500;600;700&family=Fira+Code:wght@400;500;600&display=swap" rel="stylesheet">
    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            align-items: center;
            background-image: 
                radial-gradient(circle at 90% 20%, rgba(58, 123, 213, 0.15) 0%, transparent 40%),
                radial-gradient(circle at 10% 80%, rgba(157, 80, 187, 0.15) 0%, transparent 40%),
...
<div class="presentation-wrapper">
    ...
    <div class="pres-header">
        <div class="header-title">
            <span>⚡ המכללה האקדמית להנדסה סמי שמעון (SCE)</span>
            <span class="header-badge">מחקר מאמר IEEE TIE</span>
        </div>
        <div style="display: flex; align-items: center; gap: 12px;">
            <button class="btn-fullscreen" id="fullscreen-btn" onclick="toggleFullscreen()" title="מסך מלא (F)">
                <span id="fullscreen-icon">⛶</span>
                <span id="fullscreen-text">מסך מלא</span>
            </button>
            <div class="slide-counter">
            שקף <span id="current-slide">1</span> מתוך <span id="total-slides">16</span>
        </div>
    </div>
    </div>
    ...
    <div class="slides-container" id="slides-container">
        ...
        <div class="slide active">
            <div class="title-slide">
                <span class="tag-pill" style="margin-bottom: 15px;">מחקר מתקדם בהנע חשמלי ואימות חומרה מעבדתי</span>
                <h1>בקרה אופטימלית מבוססת תעדוף שגיאה (OEPC) עבור ממיר Series-End VSI למנועי PMSM ודיכוי זרמי סדרה אפס</h1>
                <h2>Hardware-Efficient Optimal Error-Priority Control for Series-End VSI With ZSC Suppression</h2>
                
                <div class="authors-badge-grid">
                    <div class="author-card">
                        <div class="author-name">ד"ר אלי גד ברבי</div>
                        <div class="author-role">מנחה הפרויקט ומרצה בכיר</div>
                        <div class="author-inst">המכללה האקדמית להנדסה סמי שמעון</div>
                    </div>
                    <div class="author-card" style="border-color: var(--accent-cyan);">
                        <div class="author-name">מקסים רדקין</div>
                        <div class="author-role">מועמד לתואר שני M.Sc.</div>
                        <div class="author-inst">המכללה האקדמית להנדסה סמי שמעון</div>
                    </div>
                    <div class="author-card">
                        <div class="author-name">פרופ' דמיטרי ביימל</div>
                        <div class="author-role">חבר בכיר ב-IEEE</div>
                        <div class="author-inst">המכללה האקדמית להנדסה סמי שמעון</div>
                    </div>
                </div>

                <div style="margin-top: 25px; font-size: 13px; color: var(--text-muted); font-family: 'Fira Code', monospace; direction: ltr;">
        ...
        <div class="slide">
            <div class="slide-category">התפתחות המתודולוגיה</div>
            <div class="slide-title">המעבר משיטת TDM לבקרת OEPC מרובת מטרות</div>
            <div class="slide-content-grid">
                <div class="card">
                    <div class="card-title">⏳ גישת ה-TDM הקלאסית (ריבוב חלוקת זמן)</div>
                    <ul class="list-styled">
                        <li><strong>תיקון שגיאה בודדת:</strong> ב-TDM מתקנים שגיאה קריטית אחת בלבד בכל פסיעת בקרה.</li>
                        <li><strong>מעבר מחזורי רציף:</strong> מעבר סדרתי בין הפאזות, תוך ויתור על הזדמנויות לתיקון שגיאות משניות.</li>
                        <li><strong>עקרון השימור (Preservation):</strong> החלת מתח אפס/סירקולציה עצמית על פאזות שאינן בעדיפות כדי למנוע החרפת שגיאה.</li>
                    </ul>
                </div>

                <div class="card card-highlight">
                    <div class="card-title">🚀 אסטרטגיית ה-OEPC המוצעת (תעדוף שגיאה אופטימלית)</div>
                    <ul class="list-styled">
                        <li><strong>אופטימליות מרובת מטרות:</strong> אלגוריתם ה-OEPC מנסה לתקן <em>כמה שיותר שגיאות זרם פאזה וזרם סדר-אפס בו-זמנית</em> בכל מחזור.</li>
                        <li><strong>טבלת LUT דטרמיניסטית של 96 מצבים:</strong> חתימת שגיאה בת 7 ביטים פונה ישירות למצב המיתוג האופטימלי בפחות מ-1.75 µs.</li>
                        <li><strong>עדיפות דינמית:</strong> תיקון שגיאות משניות מתבצע באופן חופשי כל עוד אינו מתנגש בתיקון השגיאה הראשית.</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="slide">
            <div class="slide-category">טופולוגיית המערכת ומידול</div>
            <div class="slide-title">ארכיטקטורת Series-End VSI ואתגר זרמי סדרה אפס (ZSC)</div>
            <div class="slide-content-grid">
                <div>
                    <div class="card" style="margin-bottom: 18px;">
                        <div class="card-title">יתרונות ממיר Series-End בעל 4 ענפים</div>
                        <ul class="list-styled">
                    ...
                    <div class="card">
                        <div class="card-title">אתגר דיכוי זרמי סדרה אפס (ZSC)</div>
                        <ul class="list-styled">
                            <li><strong>לולאת Common-Mode סגורה:</strong> היעדר נקודת כוכב צפה יוצר נתיב סגור לזרמי סדרה אפס דרך ענפים 1 ו-4 ($v_1 - v_4$).</li>
                            <li><strong>צימוד בין-פאזי:</strong> מיתוג ענף 4 משפיע בו-זמנית על כל שלושת זרמי הפאזות דרך מעגל ה-ZSC.</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="fig-box">
                    ...
                    <div class="fig-caption">איור 2: טופולוגיית Series-End VSI תלת-מופעית עם עומס Open-Winding ולולאת זרם סדר-אפס שקולה.</div>
                </div>
            </div>
        </div>
        ...
        <div class="slide">
            <div class="slide-category">אלגוריתם הבקרה</div>
            <div class="slide-title">עיבוד עדיפויות שגיאה וחתימת כתובת ל-LUT של 7 ביטים</div>
            <div class="slide-content-grid">
                <div class="card">
                    <div class="card-title">עיבוד לוגי ישיר בקואורדינטות ABC</div>
                    <ul class="list-styled">
                        <li><strong>6 שגיאות זרם:</strong> 3 שגיאות Differential-Mode ($\varepsilon_{dm}^x = i_x^* - i_x$) ו-3 שגיאות Common-Mode ($\varepsilon_{cm}^x = i_x^* + i_0^* - i_x - i_0$).</li>
                        <li><strong>בחירת שגיאות קריטיות:</strong> השוואה זוגית לבחירת השגיאה הדומיננטית $\varepsilon_{crit}(x)$ עבור כל פאזה.</li>
                        <li><strong>דגל EMP ($F_{mp}$):</strong> קובע האם התיקון הדומיננטי הוא CM (דיכוי $i_0$, כאשר $F_{mp}=0$) או DM ($F_{mp}=1$).</li>
                        <li><strong>קוד עדיפות (EPC):</strong> מיון לוגי בן 3 ביטים של גודל השגיאות המוחלט $|\varepsilon_{crit}(a)|, |\varepsilon_{crit}(b)|, |\varepsilon_{crit}(c)|$.</li>
                        <li><strong>קוד סימנים (ESC):</strong> 3 ביטים המייצגים את קוטביות השגיאות (+/-).</li>
                    </ul>
                </div>

                <div class="fig-box">
                    <img src="presentation_assets/fig3_oepc_flowchart_algorithm.jpg" alt="OEPC Flowchart Algorithm">
                    <div class="fig-caption">איור 3: תרשים זרימה של אלגוריתם הבקרה בלולאת הזרם הישירה של OEPC.</div>
                </div>
            </div>
        </div>
        ...
        <div class="slide">
            <div class="slide-category">בחירת מצבי מיתוג</div>
            <div class="slide-title">מבנה טבלת הניתוב האופטימלית בת 96 המצבים (96-Entry LUT)</div>
            <div class="slide-content-full">
                <table class="table-custom">
                    <thead>
                        <tr>
                            <th>מקרה</th>
                            <th>סדר עדיפויות (EPO)</th>
                            <th>קוד EPC</th>
                            <th>קוד ESC</th>
                            <th>דגל EMP (Fmp)</th>
                            <th>מצב מיתוג נבחר (L1 L2 L3 L4)</th>
                            <th>השפעה פיזית מתקנת על הזרמים</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr class="highlight-row">
                            ...
                            <td>$-i_a, +i_c$ (תיקון סימולטני של 2 פאזות)</td>
                        </tr>
                        <tr>
                            <td>מקרה 2</td>
                            <td>ACB</td>
                            ...
                            <td>$-i_a, +i_b, -i_c, -i_0$ (תיקון מלא של 3 פאזות + ZSC)</td>
                        </tr>
                        <tr class="highlight-row">
                            <td>מקרה 3</td>
                            <td>BAC</td>
                ...
                <div class="card" style="margin-top: 10px;">
                    <div class="card-title">⚡ עקרונות הליבה של טבלת ה-96 מצבים</div>
                    <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 15px; font-size: 13.5px;">
                        <div><strong>1. עדיפות לקסיקוגרפית:</strong> השגיאה הראשית מתוקנת תמיד ללא פשרות.</div>
                        <div><strong>2. מקסימום תיקון בו-זמני:</strong> שגיאות משניות מתוקנות במידה ואינן סותרות את הראשית.</div>
                        <div><strong>3. עקרון אי-ההפרעה:</strong> שגיאות משניות שאינן בנות-תיקון משומרות ללא החמרה.</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="sim-container">
                ...
                <div class="sim-controls-card">
                    ...
                    <div class="sliders-grid-2x2">
                        <div class="sim-control-group compact">
                            <div class="sim-control-header">
                                <span>פאזה A: <bdi class="math-term">&epsilon;<sub>a</sub></bdi></span>
                        ...
                        <div class="sim-control-group compact">
                            <div class="sim-control-header">
                                <span>פאזה B: <bdi class="math-term">&epsilon;<sub>b</sub></bdi></span>
                        ...
                        <div class="sim-control-group compact">
                            <div class="sim-control-header">
                                <span>פאזה C: <bdi class="math-term">&epsilon;<sub>c</sub></bdi></span>
                        ...
                        <div class="sim-control-group compact">
                            <div class="sim-control-header">
                                <span>סדרה אפס: <bdi class="math-term"><i>i</i><sub>zsc</sub></bdi></span>
                    ...
                    <div style="margin-top: 1px;">
                        <div style="font-size: 10.5px; color: var(--text-muted); margin-bottom: 2px; font-weight: 600;">תרחישי עבודה מוכנים:</div>
                        <div class="sim-btn-group" style="display:grid; grid-template-columns: repeat(4, 1fr); gap: 4px;">
                            <button class="sim-btn active" style="padding: 4px 2px; font-size: 11px;" id="btn-preset-nom" onclick="setPresetErrors(1.8, -1.2, -0.6, 0.0, this)">נומינלי ABC</button>
                            <button class="sim-btn" style="padding: 4px 2px; font-size: 11px;" id="btn-preset-zsc" onclick="setPresetErrors(1.5, 1.2, 0.9, 1.2, this)">חריגת ZSC</button>
                            <button class="sim-btn" style="padding: 4px 2px; font-size: 11px;" id="btn-preset-asym" onclick="setPresetErrors(-2.8, 1.4, 1.4, 0.3, this)">אי-סימטריה</button>
                            <button class="sim-btn" style="padding: 4px 2px; font-size: 11px;" id="btn-preset-itsc" onclick="setPresetErrors(2.6, -0.5, -2.1, 0.8, this)">קצר ITSC</button>
                        </div>
                    </div>

                    <!-- Priority Decoder Output -->
                    <div style="border-top: 1px solid var(--border-color); padding-top: 3px; margin-top: 1px;">
                        <div style="font-size: 10.5px; color: var(--text-muted); margin-bottom: 2px; font-weight: 600;">דירוג תעדוף שגיאות:</div>
                        <div class="priority-badge-row" style="gap: 5px;">
                            <div class="p-badge p-prime" style="padding: 3px 6px;">
                                <span style="font-size: 8.5px; opacity: 0.85;">🥇 שגיאה ראשית</span>
                                <span id="badge-prime-phase" style="font-weight:700; font-size:11.5px;">פאזה A</span>
                                <span id="badge-prime-val" class="metric" style="font-size:11px;">+1.80 A</span>
                            </div>
                            <div class="p-badge p-sec" style="padding: 3px 6px;">
                                <span style="font-size: 8.5px; opacity: 0.85;">🥈 שגיאה משנית</span>
                                <span id="badge-sec-phase" style="font-weight:700; font-size:11.5px;">פאזה B</span>
                                <span id="badge-sec-val" class="metric" style="font-size:11px;">-1.20 A</span>
                            </div>
                            <div class="p-badge p-minor" style="padding: 3px 6px;">
                                <span style="font-size: 8.5px; opacity: 0.85;">🥉 שגיאה שלישית</span>
                                <span id="badge-minor-phase" style="font-weight:700; font-size:11.5px;">פאזה C</span>
                    ...
                    <div class="lut-match-box" id="lut-decision-box" style="padding: 7px 9px; gap: 4px;">
                        <div class="lut-step-row">
                            <div style="display:flex; justify-content:space-between; align-items:center;">
                                <span class="lut-step-title" style="font-size: 11px;">📋 החלטת OEPC מתוך 96-LUT:</span>
                                <span id="lut-row-num" class="lut-mode-badge dm-badge" style="font-size: 10px; padding: 2px 6px;">⚡ עדיפות דיפרנציאלית (DM)</span>
                            </div>
                        </div>
                        
                        <!-- Real-time 7-Bit Address Signature -->
                        <div class="lut-signature-bar">
                            <span class="sig-label">כתובת 7-ביט [EPO|ESC|EMP]:</span>
                            <span class="sig-bits" id="lut-7bits">1 1 0 &nbsp;|&nbsp; 1 0 0 &nbsp;|&nbsp; 1</span>
                            <span class="sig-idx" id="lut-idx-badge">Idx=105 • שורה #88</span>
                        </div>

                        <div class="lut-vector-grid" style="padding: 4px 7px; gap: 4px;">
                            <div class="vector-chip">
                                <span class="v-label" style="font-size: 8.5px;">וקטור מיתוג נבחר (L1 L2 L3 L4):</span>
                                <span id="lut-vector-code" class="v-code" style="font-size: 12px;">[1 0 1 1] (וקטור 11)</span>
                            </div>
                            <div class="vector-chip">
                                <span class="v-label" style="font-size: 8.5px;">פעולת התיקון הפיזיקלית:</span>
                        ...
                        <div class="lut-comparison-row" style="padding-top: 3px;">
                            <div class="comp-label" style="font-size: 9px;">⚖️ עליונות OEPC מול שיטת TDM המסורתית:</div>
                            <div id="tdm-compare-note" class="comp-text" style="font-size: 10px; line-height: 1.3;">
                                שיטת TDM מתקנת פאזה אחת בלבד ומקפיאה את שאר הפאזות. אלגוריתם <strong>OEPC</strong> בוחר מצב מיתוג המבצע <strong>תיקון סימולטני של 2 הפאזות הקריטיות</strong> במקביל ללא השהיה ומאפס את הריפל!
                            </div>
                        </div>

                        <button class="btn-lut-modal" id="btn-open-lut-modal" onclick="openLutModal()">
                            📊 פתח טבלת 96-LUT מלאה עם איתור שורה בזמן אמת
                        </button>
                    </div>
                </div>
        ...
        <div class="slide">
            <div class="slide-category">אימות וסימולציית זמן אמת</div>
            <div class="slide-title">פלטפורמת הניסוי בטייפון בזמן אמת (Typhoon C-HIL Setup)</div>
            <div class="slide-content-grid">
                <div>
                    <div class="card" style="margin-bottom: 18px;">
                        <div class="card-title">ארכיטקטורת ה-C-HIL בזמן אמת</div>
                        <ul class="list-styled">
                            <li><strong>אמולטור Typhoon HIL402/HIL404:</strong> אמולציה פיזיקלית מדויקת של מנוע PMSM וממיר מתח בקצב דגימה של 1 MHz.</li>
                            <li><strong>בקר DSP פיזי:</strong> Texas Instruments TMS320F28335 / TMS320F28379D המריץ את אלגוריתם ה-OEPC בזמן אמת.</li>
                            <li><strong>זמן ריצה מזערי:</strong> לולאת הזרם של OEPC רצה בפחות מ-1.75 µs ב-150 MHz בלבד.</li>
                        </ul>
                    </div>
                    <div class="card card-highlight">
                        <div class="card-title">🔧 שילוב עמדת ה-C-HIL והאימות המעבדתי</div>
                        <p style="font-size: 14.5px; line-height: 1.55;">
                            במסגרת עבודת המחקר, שולבה עמדת ה-C-HIL המעבדתית תוך חיבור ממשקי ה-DSP והטייפון, אינטגרציית מודולי ה-GaN והחיישנים המבודדים, וביצוע הניסויים שאימתו את תוצאות המאמר.
                        </p>
                    </div>
                </div>
                ...
                <div class="fig-box">
                    ...
                    <div class="fig-caption">איור 4: (a) מערך ה-Typhoon C-HIL לניסויי זמן אמת; (b) אב-טיפוס מעבדתי של ממיר GaN Series-End VSI.</div>
                </div>
            </div>
        </div>
        ...
        <div class="slide">
            <div class="slide-category">תוצאות ניסויי C-HIL</div>
            <div class="slide-title">תגובה דינמית של מנוע ה-PMSM בזמן אמת תחת C-HIL</div>
            <div class="slide-content-grid">
                <div class="fig-box">
                    <img src="presentation_assets/fig12_chil_realtime_pmsm_results.jpg" alt="C-HIL Real-Time PMSM Results">
                    <div class="fig-caption">איור 12: תוצאות C-HIL בזמן אמת: (a) תגובת מהירות ומומנט לשינויי מדרגה; (b) זרמי 3 פאזות ודיכוי ZSC.</div>
                </div>

                <div>
                    <div class="card" style="margin-bottom: 18px;">
                        <div class="card-title">אימות ביצועים דינמיים</div>
                        <ul class="list-styled">
                            <li><strong>מעברי מהירות חדים:</strong> האצה חלקה מ-0 ל-1500 RPM בזמן התייצבות מהיר ביותר (פחות מ-50 מילי-שניות).</li>
                            <li><strong>דחיית הפרעות מומנט:</strong> קפיצת עומס פתאומית מ-5 Nm ל-45 Nm נדחית ללא נפילת מהירות משמעותית.</li>
                            <li><strong>ריפל מומנט מזערי:</strong> נשמר בתוך $\pm 0.5\text{ Nm}$ תחת עומס מלא.</li>
                        </ul>
                    </div>
                    <div class="card">
                        <div class="card-title">דיכוי מלא של זרמי סדרה אפס בזמן אמת</div>
                        <ul class="list-styled">
                            <li><strong>בלימת $i_0$:</strong> ריפל זרם ה-ZSC נשמר מתחת ל-0.42 A גם בזמן מעברים דינמיים חדים.</li>
                            <li><strong>זרמי פאזה איכותיים:</strong> זרמים סינוסואידליים נקיים ללא עיוותים לאורך כל 4 רביעי הפעולה.</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="slide" id="slide-switching-error-demo">
            <div id="demo-surge-banner" class="demo-surge-banner" style="opacity:0;">
                ⚠️ הוזרקה קפיצת שגיאה פתאומית! ה-OEPC מאתר את פאזת המקסימום ומפעיל וקטור מתקן!
            </div>

            <h2>⚡ סימולציית מיתוגים בזמן-אמת: תהליך תיקון השגיאות וחילוץ וקטורי מיתוג (OEPC Closed-Loop)</h2>
            <h3 style="color:var(--text-muted); font-size:0.92rem; margin-bottom:4px;">
                שילוב חי של דגימת זרמים &larr; מיון עדיפויות שגיאה &larr; שליפת וקטור אופטימלי מ-96-LUT &larr; מיתוג 4 הענפים (<span class="math-term"><i>S</i><sub>a</sub>, <i>S</i><sub>b</sub>, <i>S</i><sub>c</sub>, <i>S</i><sub>n</sub></span>)
            </h3>
            ...
            <div class="slide11-grid">
                ...
                <div class="slide11-card">
                    <div class="slide11-card-title">
                        <span>🌊</span> דגימת זרמים ואותות שגיאה רגעיים (<span class="math-term"><i>i</i><sub>x</sub></span> ו-<span class="math-term"><i>e</i><sub>x</sub></span>)
                    </div>
                    ...
                    <div style="margin-top:4px;">
                        <div class="demo-bar-row">
                            <span style="color:#00d2ff; font-weight:700;">פאזה A:</span>
                            <div class="demo-bar-track"><div id="demo-bar-ea" class="demo-bar-fill fill-a"></div></div>
                            <span id="demo-val-ea" class="demo-val-readout" style="color:#00d2ff;">+0.00 A</span>
                        </div>
                        <div class="demo-bar-row">
                            <span style="color:#f6d365; font-weight:700;">פאזה B:</span>
                            <div class="demo-bar-track"><div id="demo-bar-eb" class="demo-bar-fill fill-b"></div></div>
                            <span id="demo-val-eb" class="demo-val-readout" style="color:#f6d365;">+0.00 A</span>
                        </div>
                        <div class="demo-bar-row">
                            <span style="color:#ff6b81; font-weight:700;">פאזה C:</span>
                            <div class="demo-bar-track"><div id="demo-bar-ec" class="demo-bar-fill fill-c"></div></div>
                            <span id="demo-val-ec" class="demo-val-readout" style="color:#ff6b81;">+0.00 A</span>
                        </div>
                        <div class="demo-bar-row">
                            <span style="color:#00ff88; font-weight:700;">סדרה אפס (i₀):</span>
                            <div class="demo-bar-track"><div id="demo-bar-izsc" class="demo-bar-fill fill-zsc"></div></div>
                            <span id="demo-val-izsc" class="demo-val-readout" style="color:#00ff88;">+0.00 A</span>
                        </div>
                    </div>
                </div>

                <!-- PANEL 2: OEPC 96-LUT DECISION CORE & TRANSISTOR MATRIX -->
                <div class="slide11-card">
                    <div class="slide11-card-title">
                        <span>🧠</span> מנוע קבלת ההחלטות (OEPC Decision Core)
                    </div>

                    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:2px;">
                        <span style="font-size:0.78rem; color:var(--text-muted);">סדר עדיפויות שגיאה:</span>
                        <div id="demo-badge-order" class="demo-order-tag">CBA</div>
                    </div>

                    <div class="demo-ranks-container">
                        <div id="demo-badge-smx" class="demo-rank-tag rank-mx">S_mx: C (-)</div>
                        <div id="demo-badge-smd" class="demo-rank-tag rank-md">S_md: B (+)</div>
                        <div id="demo-badge-smn" class="demo-rank-tag rank-mn">S_mn: A (+)</div>
                    </div>

                    <div style="text-align:center; font-size:0.75rem; color:var(--text-muted); margin-top:2px;">
                        חתימה בינארית [Pab Pbc Pca | Smx Smd Smn | Fmp]:
                    </div>
                    <div id="demo-7bit-bin" class="demo-bin-box">
                    ...
                    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:3px;">
                        <div id="demo-lut-idx" class="demo-idx-tag" style="margin:0;">Idx = 16 (שורה #1)</div>
                        <div id="demo-fmp-badge" class="demo-pill pill-zsc">Fmp=0 (ZSC)</div>
                    </div>

                    <div class="demo-vec-hero">
                        <span class="demo-vec-label">וקטור נבחר:</span>
                        <span id="demo-active-vec" class="demo-vec-val">V_1</span>
                    </div>

                    <!-- 8-TRANSISTOR HARDWARE TOPOLOGY (FIGURE 2) -->
                    <div class="transistor-matrix-card">
                        <div class="matrix-title">
                            🔌 מצבי 8 הטרנזיסטורים ברגלי הממיר (איור 2):
                        </div>
                        <div class="matrix-grid">
                            <div class="matrix-leg" id="leg-box-a">
                                <div class="leg-header" style="color:#00d2ff;">רגל A</div>
                            ...
                            <div class="matrix-leg" id="leg-box-b">
                                <div class="leg-header" style="color:#f6d365;">רגל B</div>
                                <div class="transistor-row">
                            ...
                            <div class="matrix-leg" id="leg-box-c">
                                <div class="leg-header" style="color:#ff6b81;">רגל C</div>
                                <div class="transistor-row">
                            ...
                            <div class="matrix-leg leg-neutral" id="leg-box-n">
                                <div class="leg-header" style="color:#00ff88;">רגל N</div>
                                <div class="transistor-row">
                    ...
                    <div class="demo-impact-hero">
                        השפעה פיזיקלית: <span id="demo-active-impact" class="demo-val-readout" style="color:#f6d365; font-weight:700;">-i_c, -i_0</span>
                    </div>

                    <div class="demo-norm-box">
                        נורמת שגיאה כוללת: <span id="demo-tel-norm" class="demo-val-readout">0.12 A</span>
                    </div>
                </div>
                ...
                <div class="slide11-card">
                    <div class="slide11-card-title">
                        <span>⚡</span> אותות מיתוג 4 הרגליים (איור 2: זוגות <span class="math-term"><i>S</i><sub>h</sub>, <i>S</i><sub>l</sub></span>)
                    </div>
                    ...
                    <div class="slide11-card-title" style="margin-top:1px; font-size:0.85rem;">
                        <span>🎯</span> התכנסות שגיאה במרחב <span class="math-term">&alpha;-&beta;</span> (חץ מושך לראשית)
                    </div>
            ...
            <div class="demo-controls-bar">
                ...
                <div style="display:flex; align-items:center; gap:5px; flex-wrap:wrap;">
                    <span style="font-size:0.78rem; font-weight:700; color:var(--accent-gold); display:flex; align-items:center; gap:3px;">
                        <span>⚡</span> תרחישי תקלות:
                    </span>
                    <button id="btn-fault-none" class="demo-btn fault-btn active-fault" onclick="setDemoFault('none')">🟢 תקין</button>
                    <button id="btn-fault-surge" class="demo-btn fault-btn" onclick="setDemoFault('surge')">⚡ קפיצת שגיאה</button>
                    <button id="btn-fault-asym" class="demo-btn fault-btn" onclick="setDemoFault('asym')">🔌 אי-סימטריה 35%</button>
                    <button id="btn-fault-leg4" class="demo-btn fault-btn" onclick="setDemoFault('leg4')">⚠️ תקלת ענף 4</button>
                    <button id="btn-fault-load" class="demo-btn fault-btn" onclick="setDemoFault('load')">📈 קפיצת עומס 125%</button>
                </div>

                <!-- Playback & True Speed Slider -->
                <div style="display:flex; align-items:center; gap:10px;">
                    <div class="demo-btn-group">
                        <button id="btn-demo-play" class="demo-btn" onclick="toggleDemoPlay()">⏸ השהה</button>
                        <button class="demo-btn" onclick="stepDemoOnce()">⏯ צעד בודד</button>
                        <button class="demo-btn" onclick="resetDemo()" style="border-color:rgba(255,255,255,0.3);">🔄 איפוס</button>
                    </div>
                    ...
                    <div style="display:flex; align-items:center; gap:8px; background:rgba(0,0,0,0.45); padding:3px 10px; border-radius:6px; border:1px solid rgba(0,210,255,0.25);">
                        <span style="font-size:0.78rem; color:#cbd5e0; white-space:nowrap;">מהירות סריקה:</span>
        ...
        <div class="slide">
            <div class="slide-category">אימות חומרה מעבדתי</div>
            <div class="slide-title">מדידת מתחים דיפרנציאליים ומודולציה בתדר משתנה</div>
            <div class="slide-content-grid">
                <div class="fig-box">
                    <img src="presentation_assets/fig8_experimental_differential_voltages.jpg" alt="Experimental Differential Voltages">
                    <div class="fig-caption">איור 8: מתחים דיפרנציאליים מדודים ($v_a, v_c$) בענפים 1–2 ו-3–4 של ה-SE-VSI.</div>
                </div>

                <div>
                    <div class="card" style="margin-bottom: 18px;">
                        <div class="card-title">חלוקת מחזורי מיתוג דינמית (Duty Cycles)</div>
                        <ul class="list-styled">
                            <li><strong>סינתזת מתחים מותאמת:</strong> דפוסי מיתוג שונים מופקים בכל ענף כדי לפצות על האימפדנס הלא-מאוזן.</li>
                            <li><strong>ניצולת מתח DC מלאה:</strong> הגעה לאינדקס מודולציה מלא ($M_a = 1.0$) ללא כניסה לרוויה או קטימת גל.</li>
                        </ul>
                    </div>
                    <div class="card">
                        <div class="card-title">יתרונות מיתוג בתדר משתנה (Variable Frequency)</div>
                        <ul class="list-styled">
                            <li><strong>הפחתת הפסדים:</strong> חיסכון של עד כ-<strong>30% בהפסדי מיתוג</strong> בהשוואה לבקרת CBPWM בתדר קבוע.</li>
                            <li><strong>פיזור הרמוניות EMI:</strong> פיזור ספקטרלי טבעי של תדרי המיתוג המונע פיקים חדים של הפרעות EMI.</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="slide">
            <div class="slide-category">השוואת ביצועים ו-Benchmarking</div>
            <div class="slide-title">השוואה מקיפה: בקרת OEPC מול שיטות קונבנציונליות</div>
            <div class="slide-content-full">
                <table class="table-custom">
                    <thead>
                        <tr>
                            <th>שיטת בקרה</th>
                            <th>פלטפורמת עיבוד ותדר</th>
                            <th>זמן ריצת לולאה</th>
                            <th>עומס חישובי יחסי</th>
                            <th>הפסדי מיתוג</th>
                            <th>עמידות לחוסר איזון</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr class="highlight-row">
                            <td><strong>OEPC המוצעת</strong></td>
                            <td>TMS320F28335 (150 MHz)</td>
                            <td><strong>1.75 µs (0.85 µs ב-F28379D)</strong></td>
                            <td><strong>100% (בסיס - הנמוך ביותר)</strong></td>
                            <td><strong>הנמוכים ביותר (חיסכון ~30%)</strong></td>
                            <td><strong>מצוינת (אומת פיזית ב-&plusmn;25%)</strong></td>
                        </tr>
                        <tr>
                            <td>3-D Space Vector Modulation (3D-SVM)</td>
                            <td>dSPACE DS1202 (2.0 GHz)</td>
                            <td>0.43 µs (@ 2.0 GHz)</td>
                            <td>330% (פי 3.3 יותר כבד למחזור)</td>
                            <td>גבוהים (תדר קבוע)</td>
                            <td>בינונית (דורשת כיול מחדש)</td>
                        </tr>
                        <tr>
                            <td>Carrier-Based PWM (CBPWM)</td>
                            <td>dSPACE DS1202 (2.0 GHz)</td>
                            <td>2.10 µs (@ 2.0 GHz)</td>
                            <td>1600% (פי 16 יותר כבד)</td>
                            <td>גבוהים (מיתוג רציף)</td>
                            <td>חלשה (קפיצות הרמוניות)</td>
                        </tr>
                        <tr>
                            <td>Virtual-Vector SVM ($V^3$-SVM)</td>
                            <td>dSPACE DS1202 (2.0 GHz)</td>
                            <td>2.50 µs (@ 2.0 GHz)</td>
                            <td>1900% (פי 19 יותר כבד)</td>
                            <td>בינוניים</td>
                            <td>בינונית</td>
                        </tr>
                        <tr>
                            ...
                            <td>&gt;15000% (פי 150 יותר כבד)</td>
                            <td>בינוניים</td>
                            <td>רגישות גבוהה לפרמטרים</td>
                        </tr>
                    </tbody>
                </table>
                ...
                <div class="fig-box" style="margin-top: 15px;">
                    ...
                    <div class="fig-caption">איור 11: השוואה במצב מתמיד: (a) שיטת OEPC ($THD = 1.84\%$, ריפל $ZSC = 0.42\text{ A}$); (b) שיטת CBPWM ($THD = 3.12\%$, ריפל $ZSC = 1.57\text{ A}$).</div>
                </div>
            </div>
        </div>
        ...
        <div class="slide">
            <div class="slide-category">חסינות לתקלות פנימיות במנוע</div>
            <div class="slide-title">חסינות אינהרנטית בפני קצר פנימי בין כריכות הסליל (ITSC)</div>
            <div class="slide-content-grid">
                <div class="fig-box">
                    <img src="presentation_assets/fig13_fault_tolerance_itsc_oepc_vs_cbpwm.jpg" alt="Fault Tolerance ITSC OEPC vs CBPWM">
                    <div class="fig-caption">איור 13: תגובה דינמית תחת קצר סטטור של 10% (ITSC): (a) בקרת OEPC בולמת את הזרם; (b) בקרת CBPWM גורמת לבריחת זרם הרסנית.</div>
                </div>

                <div>
                    <div class="card" style="margin-bottom: 18px;">
                        <div class="card-title">הגנה פסיבית ללא צורך בחיישנים נוספים</div>
                        <ul class="list-styled">
                            <li><strong>סימולציית תקלת סליל:</strong> יצירת קצר של 10% בין כריכות הסליל (ITSC) במהלך פעולת המנוע.</li>
                            <li><strong>קריסת בקרת CBPWM:</strong> בקרת ה-PWM הרגילה אינה מסוגלת להכיל את זרם התקלה וגורמת לבריחת זרם מסוכנת.</li>
                            <li><strong>בלימה טבעית של OEPC:</strong> לוגיקת עדיפות השגיאה בולמת פסיבית את זרם התקלה ומונעת בריחת זרם!</li>
                        </ul>
                    </div>
                    <div class="card card-highlight">
                        <div class="card-title">🛡️ הגנה תרמית ומכנית קריטית (Limp-Home)</div>
                        <p style="font-size: 14.5px; line-height: 1.55;">
                            מעניק יכולת המשך נסיעה בטוחה (Limp-Home Mode) עבור כלי רכב חשמליים ומערכות תעופה קריטיות ללא צורך במתבוננים (Observers) מורכבים.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="slide">
            <div class="slide-category">תרומה מחקרית ופרסום מאמר</div>
            <div class="slide-title">פרסום המאמר ב-IEEE TIE והבסיס הניסויי להצלחתו</div>
            <div class="slide-content-grid">
                <div class="card card-highlight">
                    <div class="card-title">🌟 קבלת המאמר בכתב העת המוביל IEEE TIE</div>
                    <ul class="list-styled">
                        <li><strong>הגורם המכריע:</strong> האימות המעבדתי הפיזיקלי המקיף ותוצאות ה-C-HIL היו הבסיס המרכזי לקבלת המאמר ב-IEEE Transactions on Industrial Electronics (כתב עת Q1 מהשורה הראשונה).</li>
                        <li><strong>השתלבות בעבודה הניסויית:</strong> ביצוע אינטגרציית החומרה, ממשקי ה-DSP והטייפון ואיסוף הנתונים המעשיים בניסויי המעבדה. (אי-רישומו הרשמי של מקסים רדקין נבע ממדיניות הקפאת שמות מחברים של IEEE לאחר סבב השיפוט הראשון).</li>
                    </ul>
                </div>

                <div class="card">
                    <div class="card-title">🔬 משימות החומרה והאימות המעבדתי</div>
                    <ul class="list-styled">
                        <li><strong>ממשק ה-DSP וה-C-HIL:</strong> חיבור, תכנות וכיול בקר ה-TMS320 מול אמולטור הטייפון.</li>
                        <li><strong>הרכבת ממיר ה-GaN:</strong> תכנון, חיווט ודיבאגינג של דרגת ההספק בממיר 4 ענפים Series-End.</li>
                        <li><strong>עמדת עומס RL לא-מאוזנת:</strong> כיול סלילי עומס לא-מאוזנים ב-$\pm 25\%$ ועריכת מבחני מאמץ.</li>
                        <li><strong>מדידות ועיבוד אותות:</strong> איסוף נתונים באוסצילוסקופ 4-ערוצי מהיר וניתוח הרמוני (FFT).</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="slide">
            <div class="slide-category">המשך המחקר ושלבים הבאים</div>
            <div class="slide-title">התקדמות החומרה: מנוע ה-PMSM החדש שנרכש והממירים שנבנו</div>
            <div class="slide-content-grid">
                <div>
                    <div class="card" style="margin-bottom: 18px;">
                        <div class="card-title">מנוע PMSM תעשייתי חדש בסלילים פתוחים</div>
                        <ul class="list-styled">
                            <li><strong>מנוע SEW / OEMER PMSM תעשייתי:</strong> סרוו-מנוע איכותי עם סלילים פתוחים ואנקודר אופטי בדיוק גבוה SICK SFM60 Hiperface.</li>
                            <li><strong>מעמד עומס מכני ייעודי:</strong> שולחן מכונה מודולרי (MV1004) עם חיישן מומנט אינליין (T210) ומצמד דיינו.</li>
                        </ul>
                    </div>
                    <div class="card card-highlight">
                        <div class="card-title">ממירי מתח ייעודיים שנבנו במעבדה</div>
                        <ul class="list-styled">
                            <li><strong>ייצור ממירים עצמאי:</strong> בנייה מלאה של כרטיסי דרגת הספק SE-VSI עבור ניסויי דיינו בעומס מלא.</li>
                            <li><strong>המשך הניסויים:</strong> ביצוע סדרת בדיקות מעשיות מקיפות עם המנוע התעשייתי החדש, אינטגרציית החיישנים ובדיקת בקרת החלשת שדה (Field-Weakening).</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="fig-box">
                    ...
                    <div class="fig-caption">מנוע ה-PMSM התעשייתי בסלילים פתוחים שנרכש לצורך ניסויי ההמשך בעמדת הדיינו.</div>
                </div>
            </div>
        </div>
        ...
        <div class="slide">
            <div class="slide-category">שילוב מכני ומבני</div>
            <div class="slide-title">מכלול מכני בתלת-ממד (SolidWorks CAD) ואינטגרציית חיישנים</div>
            <div class="slide-content-grid">
                <div class="fig-box">
                    <img src="presentation_assets/hardware_setup_photo.jpg" alt="Mechanical Test Stand Photo">
                    <div class="fig-caption">עמדת הניסוי המכנית במעבדה: שולחן המכונה, חיישן המומנט T210 ותושבות מנוע ה-PMSM.</div>
                </div>

                <div>
                    <div class="card" style="margin-bottom: 18px;">
                        <div class="card-title">התכנון והאינטגרציה המכנית שהושלמו</div>
                        <ul class="list-styled">
                            <li><strong>מידול 3D ב-SolidWorks:</strong> תכנון מלא של עמדת המנוע (<code>PMSM_Load_Stend.SLDASM</code>), מתאמים ומצמדים.</li>
                            <li><strong>תושבת מד מומנט T210:</strong> דיוק יישור צירי לצורך מדידות מומנט רציף ונצילות אנרגטית.</li>
                            <li><strong>פרוטוקול אנקודר SICK SFM60 Hiperface:</strong> פענוח תקשורת טורית RS485 ב-DSP לקבלת זווית רוטור מדויקת לבקרת שדה (FOC / OEPC).</li>
                        </ul>
                    </div>
                    <div class="card">
                        <div class="card-title">🔬 מערכת הנדסית שלמה ואינטגרטיבית</div>
                        <p style="font-size: 14.5px; line-height: 1.55;">
                            שילוב מתקדם של מידול אלקטרומגנטי, סימולציית זמן אמת (C-HIL), אלקטרוניקת הספק GaN, מכניקה מדויקת ותקשורת טורית מהירה.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="slide">
            <div class="slide-category">סיכום ומסקנות</div>
            <div class="slide-title">סיכום ההישגים המרכזיים והתרומה הטכנולוגית</div>
            <div class="slide-content-grid">
                <div class="card card-highlight">
                    <div class="card-title">💎 פריצות הדרך ההנדסיות</div>
                    <ul class="list-styled">
                        <li><strong>מהירות חישוב שוברת שיאים:</strong> ריצה בפחות מ-1.75 µs על בקר DSP סטנדרטי וזול באמצעות LUT.</li>
                        <li><strong>דיכוי מלא של ZSC:</strong> ביטול מוחלט של זרמי סדר-אפס ללא צורך במסננים פסיביים מגושמים או שנאים.</li>
                        <li><strong>ניצול מלא של מקור ה-DC:</strong> הפקת $M_a = 1.0$ השווה לממירי 6 ענפים, תוך חיסכון של 33% במתגים.</li>
                        <li><strong>נצילות גבוהה:</strong> הפחתה של כ-30% בהפסדי מיתוג הודות לתדר מיתוג משתנה.</li>
                        <li><strong>חסינות מובנית:</strong> עמידות לחוסר איזון של $\pm 25\%$ ולקצרים פנימיים בסליל המנוע (ITSC).</li>
                    </ul>
                </div>

                <div class="card">
                    <div class="card-title">📊 אימות מעבדתי והמשך המחקר</div>
                    <ul class="list-styled">
                        <li><strong>אימות תלת-שכבתי מושלם:</strong> נבדק בסימולציה ספרתית, בטייפון C-HIL בזמן אמת, ובחומרה פיזית מעבדתית.</li>
                        <li><strong>פרסום ב-IEEE TIE:</strong> הכרה אקדמית בינלאומית המשלבת פיתוח תיאורטי חדשני ואימות מעבדתי מדויק.</li>
                        <li><strong>המשך מחקר פעיל:</strong> שלב בדיקות הדיינו עם מנוע ה-PMSM התעשייתי החדש והממירים שנבנו.</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="slide">
            <div class="title-slide">
                <span class="tag-pill" style="margin-bottom: 20px;">פתוח לשאלות ודיון</span>
                <h1 style="font-size: 46px;">תודה רבה על ההקשבה!</h1>
                <h2 style="font-size: 24px; margin-bottom: 30px; font-family: 'Rubik', sans-serif;">שאלות ותשובות</h2>
                
                <div class="card" style="max-width: 650px; padding: 25px;">
                    <div style="font-size: 17px; font-weight: 700; color: var(--accent-cyan); margin-bottom: 8px;">
                    ...
                    <div style="font-family: 'Heebo', sans-serif; font-size: 15px; color: var(--text-secondary);">
                        מקסים רדקין | ד"ר אלי גד ברבי | פרופ' דמיטרי ביימל
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="pres-footer">
        <div class="keyboard-hint">
            ⌨️ נווט באמצעות מקשי החצים <kbd>→</kbd> <kbd>←</kbd> או הכפתורים | מסך מלא <kbd>F</kbd></div>
        <div class="nav-controls">
            <button class="btn-nav" id="footer-fullscreen-btn" onclick="toggleFullscreen()" title="מסך מלא (F)" style="background: rgba(0, 210, 255, 0.12); border-color: rgba(0, 210, 255, 0.35); color: var(--accent-cyan);">
                ⛶ מסך מלא
            </button>
...
// Helper to format physical impact into beautiful mathematical HTML
function formatPhysicalImpact(impact) {
    if (!impact || impact === 'None') return '<span style="color:var(--text-muted)">ללא השפעה</span>';
    
    // Check if it has ZSC impact
    const isZsc = impact.includes('Z');
    const badgeClass = isZsc ? 'zsc-tag' : 'dm-tag';
    const tagTitle = isZsc ? 'דיכוי ZSC' : 'תיקון 2 פאזות';
...
function populateLutModalTable() {
    ...
    for (let idx = 16; idx <= 111; idx++) {
        ...
        html += `<tr id="lut-row-${idx}" data-idx="${idx}" data-row="${r.row}" data-ep="${r.ep}" data-impact="${r.impact}">
            ...
            <td><span class="vidx-pill">וקטור ${r.vIdx}</span></td>
...
function updateErrorPrinciple() {
    ...
    // Add micro-epsilon to guarantee unambiguous strict sorting
    const epsA = absA;
    ...
    // Fmp = 0 when Common-Mode (ZSC) dominates (|izsc| > 0.35 A)
    // Fmp = 1 when Differential-Mode dominates
    ...
    if (idxBadgeEl) {
        idxBadgeEl.textContent = `Idx=${addr} • שורה #${lutMatch.row} (${lutMatch.ep})`;
    }
    ...
    if (badgeEl) {
        if (fmp === 0) {
            badgeEl.textContent = `⚠️ עדיפות סדרה אפס (CM Priority, Fmp=0) • שורה #${lutMatch.row}`;
            badgeEl.className = 'lut-mode-badge cm-badge';
        } else {
            badgeEl.textContent = `⚡ עדיפות דיפרנציאלית (DM Priority, Fmp=1) • שורה #${lutMatch.row}`;
    ...
    if (vCodeEl) {
        vCodeEl.textContent = `[${lutMatch.l.join(' ')}] (וקטור ${lutMatch.vIdx})`;
    }
    ...
    // Physical V0 voltage applied to open-winding neutral/4th leg
    ...
    if (compEl) {
        if (fmp === 0) {
            compEl.innerHTML = `חריגת ZSC (${(izsc>=0?'+':'')+izsc.toFixed(2)} A) מחייבת דיכוי מיידי! שיטת TDM מתעלמת מ-ZSC ומעוותת את כל הזרמים. אלגוריתם <strong>OEPC</strong> בוחר את <strong>שורה #${lutMatch.row} ב-LUT</strong>, מפעיל וקטור ${lutMatch.vIdx} ומאפס את זרם הסדרה-אפס ללא הפרעה לשאר הפאזות!`;
        } else {
            compEl.innerHTML = `שגיאות דיפרנציאליות שולטות. שיטת TDM מתקנת פאזה אחת בלבד ומקפיאה את השאר. אלגוריתם <strong>OEPC</strong> פונה לשורה #${lutMatch.row} ב-LUT ומפעיל וקטור המבצע <strong>${lutMatch.impact}</strong> בו-זמנית בתוך 1.75 µs!`;
        }
    }
    ...
    if (mVec) mVec.textContent = `[${lutMatch.l.join(' ')}] (וקטור ${lutMatch.vIdx} • ${lutMatch.impact})`;
...
function updateDemoUI() {
        ...
        if (elIdx) {
            elIdx.innerHTML = `<span style="direction:ltr; unicode-bidi:isolate; display:inline-block; font-family:monospace; font-weight:700;">Idx = ${activeAddr}</span> <span>(שורה #${activeRow})</span>`;
        }
    ...
    function renderOscilloscopeCanvas() {
        ...
        ctx.fillText('CH2: 0.5 A/div (שגיאות e_x וזרם סדרה אפס i_zsc)', leftMargin + 8 * dpr, midY + 14 * dpr);
...
function renderErrorOrbitCanvas() {
        ...
        const rings = [
            ...
            { rAmp: 0.20, lbl: 'תחום סבילות ±0.2A (Deadband)', color: 'rgba(0, 255, 136, 0.55)', isDashed: true, fill: 'rgba(0, 255, 136, 0.05)' },
        ...
        ctx.textAlign = 'left';
        ctx.fillStyle = '#00d2ff';
        ctx.fillText(`גודל שגיאה |e_αβ|: ${normE.toFixed(2)} A`, 10 * dpr, 16 * dpr);

        const inDeadband = normE <= 0.20;
        ctx.textAlign = 'right';
        ctx.fillStyle = inDeadband ? '#00ff88' : '#ff6b81';
        const statusText = inDeadband
            ? 'סטטוס: בתוך תחום הסבילות (Deadband OK)'
            : '⚠️ שגיאה חורגת (אלגוריתם OEPC מפעיל תיקון)';
...
<div id="lut-modal" class="lut-modal-overlay" style="display:none;" onclick="if(event.target===this)closeLutModal()">
    <div class="lut-modal-content">
        <div class="lut-modal-header">
            <h3>📖 טבלת הניתוב האופטימלית המלאה (OEPC 96-LUT) מתוך IEEE TIE</h3>
            <button class="lut-modal-close" onclick="closeLutModal()">&times;</button>
        </div>
        <div class="lut-modal-info">
            <span>כתובת 7-ביט נוכחית: <strong id="modal-active-addr" style="color:var(--accent-cyan)">105 (0b1101001)</strong></span>
            <span>שורה פעילה באקסל: <strong id="modal-active-row" style="color:var(--accent-gold)">#88 (ABC)</strong></span>
            <span>וקטור נבחר: <strong id="modal-active-vec" style="color:#00ff88">[1 0 1 1] (וקטור 11)</strong></span>
            <input type="text" id="lut-search-input" placeholder="סנן לפי פרמוטציה (ABC), השפעה (+A), או וקטור..." oninput="filterLutTable(this.value)" class="lut-search-box">
        </div>
...
with open(PMSM_DIR / "OEPC_SE_VSI_PMSM_Presentation_HE.html", "w", encoding="utf-8") as f:
    f.write(html_he_content)
print("[OK] Created OEPC_SE_VSI_PMSM_Presentation_HE.html successfully!")


# ==============================================================================
# 2. POWERPOINT PRESENTATION (HEBREW RTL)
# ==============================================================================
def create_hebrew_pptx():
    prs = Presentation()
    ...
    def add_card(slide, left, top, width, height, title=None, items=None, border_color=C_BLUE):
    ...
    tb1 = s1.shapes.add_textbox(Inches(0.8), Inches(1.1), Inches(11.7), Inches(3.2))
    tf1 = tb1.text_frame
    tf1.word_wrap = True

    p = tf1.paragraphs[0]
    p.text = "מחקר מתקדם בהנע חשמלי ואימות חומרה מעבדתי"
    p.font.name = "Arial"
    p.font.size = Pt(13)
    p.font.bold = True
    ...
    p2.text = "בקרה אופטימלית מבוססת תעדוף שגיאה (OEPC) עבור ממיר Series-End למנועי PMSM ודיכוי זרמי סדרה אפס"
    p2.font.name = "Arial"
    p2.font.size = Pt(25)
    p2.font.bold = True
    ...
    p3.text = "Hardware-Efficient Optimal Error-Priority Control for Series-End VSI With ZSC Suppression"
    p3.font.name = "Arial"
    p3.font.size = Pt(16)
    ...
    add_card(s1, Inches(8.8), Inches(4.7), Inches(3.3), Inches(1.8),
             title="ד\"ר אלי גד ברבי",
             items=["מנחה הפרויקט ומרצה בכיר", "המחלקה להנדסת חשמל ואלקטרוניקה", "המכללה האקדמית להנדסה סמי שמעון"])
    add_card(s1, Inches(5.0), Inches(4.7), Inches(3.3), Inches(1.8),
             title="מקסים רדקין",
             items=["מועמד לתואר שני M.Sc.", "המחלקה להנדסת חשמל ואלקטרוניקה", "המכללה האקדמית להנדסה סמי שמעון"],
             border_color=C_CYAN)
    add_card(s1, Inches(1.2), Inches(4.7), Inches(3.3), Inches(1.8),
             title="פרופ' דמיטרי ביימל",
             items=["חבר בכיר ב-IEEE", "המחלקה להנדסת חשמל ואלקטרוניקה", "המכללה האקדמית להנדסה סמי שמעון"])

    # SLIDE 2: Evolution
    s2 = add_slide_base("התפתחות המתודולוגיה", "המעבר משיטת TDM לבקרת OEPC מרובת מטרות")
    add_card(s2, Inches(6.8), Inches(1.6), Inches(5.7), Inches(5.2),
             title="⏳ גישת ה-TDM הקלאסית (Time Division Multiplexing)",
             items=[
                 "תיקון שגיאה בודדת בלבד בכל פסיעת בקרה.",
                 "מעבר מחזורי סדרתי בין הפאזות, תוך החמצת תיקון שגיאות משניות.",
                 "עקרון השימור: החלת מתח אפס/סירקולציה עצמית על פאזות שאינן בעדיפות."
             ])
    add_card(s2, Inches(0.8), Inches(1.6), Inches(5.7), Inches(5.2),
             title="🚀 אסטרטגיית ה-OEPC המוצעת (Optimal Error-Priority Control)",
             items=[
                 "אופטימליות מרובת מטרות: תיקון מקסימום שגיאות פאזה ו-ZSC בו-זמנית.",
                 "טבלת LUT דטרמיניסטית בת 96 מצבים: ריצה בפחות מ-1.75 µs.",
                 "איזון דינמי מושלם בין זרמי הפאזות (DM) לדיכוי זרם סדרה אפס (CM)."
             ],
             border_color=C_CYAN)

    # SLIDE 3: Topology
    s3 = add_slide_base("טופולוגיית המערכת ומידול", "ארכיטקטורת Series-End VSI ואתגר זרמי סדרה אפס (ZSC)")
    ...
    if img_f2.exists():
        s3.shapes.add_picture(str(img_f2), Inches(0.8), Inches(2.2), width=Inches(5.7))

    # SLIDE 4: Algorithm Flowchart
    s4 = add_slide_base("אלגוריתם הבקרה", "עיבוד עדיפויות שגיאה וחתימת כתובת ל-LUT של 7 ביטים")
    add_card(s4, Inches(6.8), Inches(1.6), Inches(5.7), Inches(5.2),
             title="עיבוד לוגי ישיר בקואורדינטות ABC",
             items=[
                 "חישוב ישיר של 6 שגיאות זרם: 3 שגיאות DM ו-3 שגיאות CM.",
                 "בחירת שגיאה קריטית לכל פאזה באמצעות השוואה זוגית.",
                 "דגל EMP (Fmp): קובע האם דיכוי ZSC (CM) או זרמי הפאזות (DM) בעדיפות.",
                 "קוד EPC: מיון לוגי של גודל השגיאות המוחלט ב-3 ביטים.",
                 "קוד ESC: ייצוג סימני השגיאה ב-3 ביטים."
             ])
    img_f3 = ASSETS_DIR / "fig3_oepc_flowchart_algorithm.jpg"
    if img_f3.exists():
        s4.shapes.add_picture(str(img_f3), Inches(0.8), Inches(1.6), width=Inches(5.7))

    # SLIDE 5: Typhoon C-HIL Setup
    s5 = add_slide_base("אימות וסימולציית זמן אמת", "פלטפורמת הניסוי בטייפון בזמן אמת (Typhoon C-HIL Setup)")
    add_card(s5, Inches(6.8), Inches(1.6), Inches(5.7), Inches(5.2),
             title="ארכיטקטורת ה-C-HIL והאימות המעבדתי",
             items=[
                 "אמולטור Typhoon HIL402/HIL404 המדמה את המנוע והממיר בקצב 1 MHz.",
                 "בקר DSP פיזי (TMS320F28335 / F28379D) המריץ את OEPC בזמן אמת.",
                 "זמן ביצוע מעגלי מזערי: לולאת זרם ב-1.75 µs ב-150 MHz.",
                 "אינטגרציית המערכת: חיבור ממשקי ה-DSP והטייפון, כיול חיישנים ואימות החומרה."
             ],
             border_color=C_CYAN)
    img_f4 = ASSETS_DIR / "fig4_experimental_setups_chil_prototype.jpg"
    if img_f4.exists():
        s5.shapes.add_picture(str(img_f4), Inches(0.8), Inches(1.8), width=Inches(5.7))

    # SLIDE 6: C-HIL Results
    s6 = add_slide_base("תוצאות ניסויי C-HIL", "תגובה דינמית של מנוע ה-PMSM בזמן אמת תחת C-HIL")
    ...
    add_card(s6, Inches(6.8), Inches(1.6), Inches(5.7), Inches(5.2),
             title="ביצועים דינמיים ודיכוי ZSC",
             items=[
                 "האצה מ-0 ל-1500 RPM בזמן התייצבות מהיר ביותר (< 50 ms).",
                 "דחיית הפרעות מומנט חדות (5 Nm עד 45 Nm) ללא נפילת מהירות.",
                 "ריפל מומנט שנשמר בטווח של +/- 0.5 Nm בלבד.",
                 "דיכוי מוחלט של ZSC: ריפל i0 נבלם מתחת ל-0.42 A בכל המעברים."
             ])

    # SLIDE 7: Hardware Load Asymmetry
    s7 = add_slide_base("אימות חומרה מעבדתי", "תוצאות ניסוי מעבדה תחת חוסר איזון פיזי קיצוני (+/- 25%)")
    add_card(s7, Inches(6.8), Inches(1.6), Inches(5.7), Inches(5.2),
             title="מבחן מאמץ על אב-טיפוס ממיר GaN",
             items=[
                 "אב-טיפוס מעבדתי מבוסס טרנזיסטורי GaN Systems GS66516B.",
                 "חוסר איזון פיזי מכוון של +/- 25% בסלילי העומס (7.5, 10, 12.5 mH).",
                 "זרמים סינוסואידליים מאוזנים לחלוטין עם THD = 1.57%.",
                 "ריפל ZSC שנבלם ל-0.19 A בלבד תחת א-סימטריה קשה."
             ],
             border_color=C_CYAN)
    img_f9 = ASSETS_DIR / "fig9_experimental_three_phase_currents_zsc.jpg"
    if img_f9.exists():
        s7.shapes.add_picture(str(img_f9), Inches(0.8), Inches(2.0), width=Inches(5.7))

    # SLIDE 8: Experimental Voltages
    s8 = add_slide_base("אימות חומרה מעבדתי", "מדידת מתחים דיפרנציאליים ומודולציה בתדר משתנה")
    ...
    add_card(s8, Inches(6.8), Inches(1.6), Inches(5.7), Inches(5.2),
             title="חלוקת Duty Cycles ונצילות אנרגטית",
             items=[
                 "דפוסי מיתוג שונים מופקים בכל ענף לפיצוי על חוסר האיזון.",
                 "ניצולת מתח DC מלאה (Ma = 1.0) ללא כניסה לרוויה.",
                 "תדר מיתוג משתנה: מפחית כ-30% מהפסדי המיתוג ביחס ל-PWM רגיל.",
                 "פיזור הרמוניות EMI טבעי ללא פיקים חדים."
             ])

    # SLIDE 9: Benchmarking
    s9 = add_slide_base("השוואת ביצועים ו-Benchmarking", "השוואה מקיפה: בקרת OEPC מול שיטות קונבנציונליות")
    add_card(s9, Inches(6.8), Inches(1.6), Inches(5.7), Inches(5.2),
             title="עומס חישובי ויעילות מיתוג",
             items=[
                 "זמן ריצת OEPC: 1.75 µs ב-150 MHz - העומס הנמוך ביותר (100%).",
                 "3D-SVM: עומס כבד פי 3.3 למחזור ותדר מיתוג קבוע.",
                 "CBPWM: עומס כבד פי 16; סובלת מקפיצות זרם בזמני Dead-Time.",
                 "Multi-Vector MPC: עומס כבד פי 150 ורגישות גבוהה לפרמטרים."
             ])
    img_f11 = ASSETS_DIR / "fig11_steady_state_comparison_oepc_cbpwm.jpg"
    if img_f11.exists():
        s9.shapes.add_picture(str(img_f11), Inches(0.8), Inches(2.2), width=Inches(5.7))

    # SLIDE 10: Fault Tolerance
    s10 = add_slide_base("חסינות לתקלות פנימיות במנוע", "חסינות אינהרנטית בפני קצר פנימי בין כריכות הסליל (ITSC)")
    ...
    add_card(s10, Inches(6.8), Inches(1.6), Inches(5.7), Inches(5.2),
             title="הגנה פסיבית ובלימת זרם תקלה",
             items=[
                 "קצר סטטור של 10% (ITSC) נבדק במצב מתמיד.",
                 "CBPWM נכשלת לחלוטין וגורמת לבריחת זרם מסוכנת והרסנית.",
                 "OEPC בולמת פסיבית את זרם התקלה ושומרת על פעולה יציבה.",
                 "יכולת Limp-Home קריטית לרכב חשמלי ותעופה ללא חיישנים נוספים."
             ],
             border_color=C_CYAN)

    # SLIDE 11: IEEE TIE Milestone
    s11 = add_slide_base("תרומה מחקרית ופרסום מאמר", "פרסום המאמר ב-IEEE TIE והבסיס הניסויי להצלחתו")
    add_card(s11, Inches(6.8), Inches(1.6), Inches(5.7), Inches(5.2),
             title="🌟 קבלת המאמר בכתב העת היוקרתי IEEE TIE",
             items=[
                 "האימות המעבדתי וה-C-HIL היו הגורם המכריע לקבלת המאמר.",
                 "ביצוע אינטגרציית החומרה, ממשקי ה-DSP והאימות הניסויי.",
                 "אי-רישומו הרשמי נבע ממדיניות הקפאת שמות של IEEE לאחר סבב ראשון.",
                 "הניסויים שבוצעו היוו את אבן היסוד שסללה את קבלת המאמר."
             ],
             border_color=C_CYAN)
    add_card(s11, Inches(0.8), Inches(1.6), Inches(5.7), Inches(5.2),
             title="🛠️ תרומת החומרה והניסויים שבוצעו ע\"י מקסים",
             items=[
                 "חיבור וכיול בקר ה-DSP מול אמולטור הטייפון בזמן אמת.",
                 "תכנון והרכבת דרגת ההספק של ממיר ה-GaN Series-End.",
                 "כיול עמדת עומס RL לא-מאוזנת ב-+/- 25% ומבחני מאמץ.",
                 "איסוף נתוני אוסצילוסקופ מהיר ועיבוד אותות הרמוני (FFT)."
             ])

    # SLIDE 12: Next Steps PMSM & Inverters
    s12 = add_slide_base("המשך המחקר ושלבים הבאים", "התקדמות החומרה: מנוע ה-PMSM החדש והממירים שנבנו")
    add_card(s12, Inches(6.8), Inches(1.6), Inches(5.7), Inches(5.2),
             title="עמדת הניסוי החדשה והמשך המחקר",
             items=[
                 "מנוע PMSM תעשייתי חדש בסלילים פתוחים עם אנקודר אופטי SICK.",
                 "ממירי SE-VSI ייעודיים שנבנו במעבדה עבור בדיקות דיינו בעומס מלא.",
                 "המשך הניסויים המעשיים על גבי המנוע החדש ובדיקות בקרת שדה.",
                 "אינטגרציה מלאה של מדידת נצילות, מומנט והחלשת שדה."
             ],
             border_color=C_CYAN)
    img_pmsm = ASSETS_DIR / "pmsm_motor_photo.jpeg"
    if img_pmsm.exists():
        s12.shapes.add_picture(str(img_pmsm), Inches(0.8), Inches(1.8), width=Inches(5.7))

    # SLIDE 13: Mechanical Integration
    s13 = add_slide_base("שילוב מכני ומבני", "מכלול מכני בתלת-ממד (SolidWorks CAD) ואינטגרציית חיישנים")
    ...
    add_card(s13, Inches(6.8), Inches(1.6), Inches(5.7), Inches(5.2),
             title="תכנון מכני מדויק ואינטגרציית חיישנים",
             items=[
                 "מידול 3D מלא ב-SolidWorks של עמדת המנוע (PMSM_Load_Stend.SLDASM).",
                 "תושבת מד מומנט T210 למדידות דינמיות ונצילות.",
                 "פענוח פרוטוקול RS485 של אנקודר SICK Hiperface לקבלת זווית רוטור.",
                 "מערכת הנדסית שלמה המשלבת בקרה, תוכנה, חומרה ומכניקה."
             ])

    # SLIDE 14: Summary
    s14 = add_slide_base("סיכום ומסקנות", "סיכום ההישגים המרכזיים והתרומה הטכנולוגית")
    add_card(s14, Inches(6.8), Inches(1.6), Inches(5.7), Inches(5.2),
             title="💎 פריצות הדרך ההנדסיות",
             items=[
                 "חישוב אולטרה-מהיר (< 1.75 µs) על גבי DSP סטנדרטי וזול.",
                 "דיכוי מלא של ZSC ללא מסננים פסיביים או שנאי בידוד.",
                 "ניצולת DC מקסימלית (Ma = 1.0) ב-33% פחות מתגים.",
                 "חיסכון של כ-30% בהפסדי מיתוג הודות לתדר משתנה.",
                 "חסינות מוכחת לחוסר איזון של +/- 25% ולקצרים פנימיים."
             ],
             border_color=C_CYAN)
    add_card(s14, Inches(0.8), Inches(1.6), Inches(5.7), Inches(5.2),
             title="📊 אימות מעבדתי והמשך המחקר",
             items=[
                 "אימות תלת-שכבתי: סימולציה, טייפון C-HIL וחומרה פיזית מעבדתית.",
                 "פרסום יוקרתי ב-IEEE TIE שהתבסס על תוצאות הניסויים של מקסים.",
                 "המשך מחקר פעיל עם מנוע ה-PMSM התעשייתי החדש והממירים שנבנו."
             ])
    ...
    p3.text = "המחלקה להנדסת חשמל ואלקטרוניקה - המכללה האקדמית להנדסה סמי שמעון (SCE)"
    p3.font.name = "Arial"
    p3.font.size = Pt(18)
    p3.font.color.rgb = C_GRAY
    p3.alignment = PP_ALIGN.CENTER
    ...
    output_pptx = PMSM_DIR / "OEPC_Series_End_PMSM_Presentation_HE.pptx"
    prs.save(str(output_pptx))
    print(f"[OK] Generated Hebrew PowerPoint presentation successfully:\n{output_pptx}")

if __name__ == "__main__":
    if HAS_PPTX:
        create_hebrew_pptx()
    else:
        print("[NOTE] python-pptx not installed. HTML presentation generated successfully!")
